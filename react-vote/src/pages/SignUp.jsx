    ...
    return (
        <div className="d-flex justify-content-center align-items-center" style={{ minHeight: '100vh', padding: '0', overflow: 'hidden' }}>
            ...
            <div className="container-fluid d-flex justify-content-center align-items-center" style={{ padding: '0', flex: 1 }}>
                {/* Left Branding Panel */}
                <div className="left-panel" style={{ height: '80vh' }}>
                    <h1 className="display-6 mb-3">My Vote My Rights</h1>
                    <img src={white} alt="Vote" className="img-fluid" style={{ maxWidth: "80%", maxHeight: "100%" }} /> {/* Set image max height */}
                </div>

                {/* Right Form Panel */}
                <div className="card-wrapper" style={{ height: '60vh', width: '50%' }}> {/* Reduced form height */}
                    <div className="card shadow-lg border-0 p-4" style={{ height: '100%' }}>
                        ...
                        <form onSubmit={handleSubmit(onSubmit)} style={{ display: 'flex', flexDirection: 'column', height: '100%' }}>
                            {/* Form fields area with scroll */}
                            <div className="form-fields overflow-auto" style={{ flex: '1', overflowY: 'auto' }}>
                                {/* Role Selection */}
